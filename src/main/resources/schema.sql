...
INSERT INTO pets (birth_date_pets, breed_pets, name_pets, sex_pets, type_pets) VALUES ('2023-06-09', 'Спаниель', 'Барбос', 'FEMALE', 'DOG');
...
INSERT INTO rooms (number_rooms, area_rooms, category_id_rooms, description_rooms, visible_rooms) VALUES ('1F', 10, 1, 'Номер с отдельным входом', true);
...
(
    ...
    name_owners                    VARCHAR(255)                            NOT NULL,
    email_owners                   VARCHAR(254)                            NOT NULL,
    main_phone_owners              VARCHAR(16)                             NOT NULL,
    optional_phone_owners          VARCHAR(16),
    instagram_owners               VARCHAR(255),
    youtube_owners                 VARCHAR(255),
    facebook_owners                VARCHAR(255),
    tiktok_owners                  VARCHAR(255),
    twitter_owners                 VARCHAR(255),
    telegram_owners                VARCHAR(255),
    whatsapp_owners                VARCHAR(255),
    viber_owners                   VARCHAR(255),
    vk_owners                      VARCHAR(255),
    prefer_communication_owners    VARCHAR(16) DEFAULT 'MAIN_PHONE'        NOT NULL,
    car_registration_number_owners varchar(9),
    CONSTRAINT pk_owner PRIMARY KEY (id_owners),
    CONSTRAINT UQ_OWNER_EMAIL UNIQUE (email_owners)
);
