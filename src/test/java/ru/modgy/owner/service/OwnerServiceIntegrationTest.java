...
//                () -> assertEquals(newOwnerDto1.getFirstName(), addedOwnerDto1.getFirstname(),
...
//                        "id field test failed"),
//                () -> assertEquals(ownerById.getFirstname(), addedOwnerDto1.getFirstname(),
//                        "name field test failed"),
...
//                () -> assertEquals(shortOwnerById.getFirstname(), addedOwnerDto1.getFirstname(),
//                        "name field test failed"),
...
//                        "id field test failed"),
//                () -> assertEquals(updateOwner.getFirstname(), addedOwnerDto1.getFirstname(),
//                        "name field test failed"),
...
//                () -> assertEquals(shortOwnerByIdAfterUpd.getFirstname(), addedOwnerDto1.getFirstname(),
//                        "name field test failed"),
